...
//            int canInsertCount = BundleItemScreenHandler.this.countCanInsertToBundle(stack);
//            return canInsertCount != 0 && (count <= canInsertCount || (this.getStack().isEmpty() || ItemStack.areItemsAndComponentsEqual(this.getStack(), stack)));
