...
public class ModConfigMenu {
    public static Screen getModConfigMenu(Screen screen){
        ...
        enabledSection.addConfigItem(new BooleanItem(Text.translatable("key.quickshulker.config.quickBundle"), options.quickBundle, true).setSaveConsumer(value -> options.quickBundle = value).setRequiresRestart());
