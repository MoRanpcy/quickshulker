...
public class ConfigOptions implements AbstractConfigFile {
    ...
    public CustomKeyBinding keybinding = CustomKeyBinding.configDefault(QuickShulker.MOD_ID, "key.keyboard.k");
    @Comment("Open setting gui key")
    public CustomKeyBinding openSettingGui = CustomKeyBinding.configDefault(QuickShulker.MOD_ID, "key.keyboard.keypad.add");
